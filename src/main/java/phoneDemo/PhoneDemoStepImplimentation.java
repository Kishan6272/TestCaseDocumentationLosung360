...
public class PhoneDemoStepImplimentation extends CommonUtils {
   ...
   public void addToContactSucessfull() throws InterruptedException {
       ...
       Thread.sleep(1000);
       CommonUtils.androidDriver.get().findElement(By.xpath("//android.widget.EditText[@text=\"First name\"]")).sendKeys("Kishan");
       CommonUtils.androidDriver.get().findElement(By.xpath("//android.widget.EditText[@text=\"Last name\"]")).sendKeys("Kumar");
       ...
       CommonUtils.androidDriver.get().findElement(By.xpath("//android.widget.EditText[@text=\"Phone\"]")).sendKeys("12345");
